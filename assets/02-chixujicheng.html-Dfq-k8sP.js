import{_ as p,c,d as o,e as s,f as a,b as e,w as d,r as l,o as u}from"./app-DeqJ5waz.js";const r={},v={href:"https://developer.huawei.com/consumer/cn/doc/harmonyos-guides-V5/ide-command-line-0000001821000581-V5",target:"_blank",rel:"noopener noreferrer"};function m(k,n){const i=l("ExternalLinkIcon"),t=l("RouteLink");return u(),c("div",null,[n[4]||(n[4]=o(`<h1 id="持续集成" tabindex="-1"><a class="header-anchor" href="#持续集成"><span>持续集成</span></a></h1><blockquote><p>搭建CI/CD流程</p></blockquote><h2 id="🔄-ci-cd流程" tabindex="-1"><a class="header-anchor" href="#🔄-ci-cd流程"><span>🔄 CI/CD流程</span></a></h2><h3 id="构建流程" tabindex="-1"><a class="header-anchor" href="#构建流程"><span>构建流程</span></a></h3><div class="language-yaml line-numbers-mode" data-highlighter="prismjs" data-ext="yml" data-title="yml"><pre><code><span class="line"><span class="token comment"># .gitlab-ci.yml</span></span>
